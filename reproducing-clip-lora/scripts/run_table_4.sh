#!/bin/bash
# =============================================================================
# Phase 1.B — Table 4: ViT-B/32 across all available datasets
# Runs: 10 datasets × 5 shots × 3 seeds = 150 runs
#
# Usage: bash run_table_4.sh [DATA_DIR] [LOG_DIR]
#   DATA_DIR defaults to ./datasets
#   LOG_DIR  defaults to ./results/table4
#
...
echo "=============================================="
echo " Phase 1.B — Table 4 (ViT-B/32)"
...
for dataset in "${DATASETS[@]}"; do
    for shots in "${SHOTS[@]}"; do
        for seed in "${SEEDS[@]}"; do
            ...
            echo "table4,$dataset,$BACKBONE,$shots,$seed,2,q_k_v,both,all,0.25,$ACC,$STATUS,$RUN_TS,$RUN_SECS" >> "$CSV_FILE"
