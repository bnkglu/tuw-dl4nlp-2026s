#!/bin/bash
# =============================================================================
# Phase 1.C — Table 5: ViT-L/14 across all available datasets
# Runs: 10 datasets × 5 shots × 3 seeds = 150 runs
#
# Usage: bash run_table_5.sh [DATA_DIR] [LOG_DIR]
#   DATA_DIR defaults to ./datasets
#   LOG_DIR  defaults to ./results/table5
#
...
echo "=============================================="
echo " Phase 1.C — Table 5 (ViT-L/14)"
...
for dataset in "${DATASETS[@]}"; do
    for shots in "${SHOTS[@]}"; do
        for seed in "${SEEDS[@]}"; do
            ...
            echo "table5,$dataset,$BACKBONE,$shots,$seed,2,q_k_v,both,all,0.25,$ACC,$STATUS,$RUN_TS,$RUN_SECS" >> "$CSV_FILE"
